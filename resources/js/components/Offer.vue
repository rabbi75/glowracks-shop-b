...
<script>
    ...
    export default {
        ...
        methods: {
            loadProducts(page = 1) {
                axios.get("/api/v1/offer/" + "?page=" + page).then((response) => {
            ...
            productSort(page = 1) {
                ...
                let sort = this.sort;
                axios.get("/api/v1/offer/" + "?sort=" + sort).then((response) => {
                    this.products = response.data.products;
                });
            },
            priceFilter(page = 1) {
                ...
                axios.get("/api/v1/offer/" + "?minprice=" + minprice + "&&maxprice=" + maxprice).then((response) => {
                    this.products = response.data.products;
                });
            },
            AddToModal(product) {
