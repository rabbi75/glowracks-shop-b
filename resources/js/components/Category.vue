                ...
                <div class="row">
                    <div class="col-sm-12">
                        <ul>
                            ...
                            <li><router-link :to="{name: 'category', params: {slug:category.slug}}">{{category.name}}</router-link></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9">
                        <div class="category-bar col-sm-hide">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h4>{{category.name}}</h4>
                                </div>
            ...
            <div class="filtersidebar">
                ...
                <div class="sidebar">
                    <div class="custom-tree">
                        ...
                        <form @submit.prevent="priceFilter" style="padding-bottom: 10px; padding-left: 10px;">
                            <input type="text" v-model="minprice" name="minprice" placeholder="Min" class="width40 minprice" />
                            <input type="text" v-model="maxprice" name="maxprice" placeholder="Max" class="width40 maxprice" />
                            <button type="submit" class="width20">Send</button>
                        </form>
    ...
    export default {
        ...
        methods: {
            loadProducts(page = 1) {
                ...
                axios.get("/api/v1/category/" + slug + "?page=" + page).then((response) => {
            ...
            productSort(page = 1) {
                let slug = this.$route.params.slug;
                let sort = this.sort;
                axios.get("/api/v1/category/" + slug + "?sort=" + sort).then((response) => {
                    this.products = response.data.products;
                });
            },
            priceFilter(page = 1) {
                ...
                axios.get("/api/v1/category/" + slug + "?minprice=" + minprice + "&&maxprice=" + maxprice).then((response) => {
                    this.products = response.data.products;
                });
            },
            AddToModal(product) {
