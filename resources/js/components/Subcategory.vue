                ...
                <div class="row">
                    <div class="col-sm-12">
                        <ul>
                            ...
                            <li><router-link :to="{name: 'subcategory', params: {slug: subcategory.slug}}">{{subcategory.subcategoryName}}</router-link></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    export default {
        ...
        methods: {
            loadProducts(page = 1) {
                ...
                axios.get("/api/v1/subcategory/" + slug + "?page=" + page).then((response) => {
            ...
            productSort(page = 1) {
                let slug = this.$route.params.slug;
                let sort = this.sort;
                axios.get("/api/v1/subcategory/" + slug + "?sort=" + sort).then((response) => {
                    this.products = response.data.products;
                });
            },
            priceFilter(page = 1) {
                ...
                axios.get("/api/v1/subcategory/" + slug + "?minprice=" + minprice + "&&maxprice=" + maxprice).then((response) => {
                    this.products = response.data.products;
                });
            },
            AddToModal(product) {
