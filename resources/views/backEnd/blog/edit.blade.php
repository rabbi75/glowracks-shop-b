      ...
      <!--card-header -->
            <div id="form_body" class="card-body">
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="custom-bg">
                    <form action="{{url('/editor/blog/update')}}" method="POST" enctype="multipart/form-data" name="editForm">
                      @csrf
                      <div class="row">
                      ...
                      <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="summernote form-control{{ $errors->has('description') ? ' is-invalid' : '' }}">{{ $edit_data->description }}</textarea>
