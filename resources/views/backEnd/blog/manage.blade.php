      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <h3 class="card-title">Manage Blog information</h3>
      			<div class="short_button">
              <a href="{{url('editor/blog/add')}}"><i class="fa fa-plus"></i>Add</a>
      			</div>
          </div>
          <!-- /.card-header -->
                  ...
                  <td>
                  	<ul class="action_buttons dropdown">
                        ...
                        @endif
                          ...
                          <li>
                        <a class="edit_icon" href="{{url('editor/blog/edit/'.$value->id)}}" title="Edit"><i class="fa fa-edit"></i> Edit</a>
                      </li>
                      <li>
                        <form action="{{url('editor/blog/delete')}}" method="POST">
                            @csrf
                            <input type="hidden" name="hidden_id" value="{{$value->id}}">
