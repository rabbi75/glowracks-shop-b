...
@section('title','Size Editor')
@section('main_content')
<section class="content">
  <div class="container-fluid">
    <div class="card card-default">
      <div class="card-header">
          <h3 class="card-title">Editor size information</h3>
      ...
      <!--card-header -->
            <div id="form_body" class="card-body">
              <div class="row">
                <div class="col-md-8">
                  <div class="custom-bg">
                    <form action="{{url('/editor/product-size/update')}}" method="POST" enctype="multipart/form-data" name="editForm">
                      @csrf
                      <div class="row">
                        <div class="col-sm-12">
                          <input type="hidden" value="{{$edit_data->id}}" name="hidden_id">
                            <div class="form-group">
                              ...
                              <input type="text" name="sizeName" class="form-control{{ $errors->has('sizeName') ? ' is-invalid' : '' }}" value="{{$edit_data->sizeName}}">
