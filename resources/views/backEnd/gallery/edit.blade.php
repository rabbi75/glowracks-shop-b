  ...
  <div class="container-fluid">
    <div class="card card-default">
      <div class="card-header">
          <h3 class="card-title">Edit Gallery information</h3>
          <div class="short_button">
            <a href="{{url('/editor/gallery/manage')}}"><i class="fa fa-cogs"></i>Manage</a>
          </div>
      </div>
      <!--card-header -->
            <div id="form_body" class="card-body">
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="custom-bg">
                    <form action="{{url('/editor/gallery/update')}}" method="POST" enctype="multipart/form-data" name="editForm">
                      @csrf
                      <div class="row">
