                      ...
                      <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="burl" name="burl" class="form-control{{ $errors->has('burl') ? ' is-invalid' : '' }}" value="{{ old('burl') }}">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="type">Category <span>*</span></label>
                                <select class="form-control select2{{ $errors->has('type') ? ' is-invalid' : '' }}" value="{{ old('type') }}" id="type" name="type">
                                    <option value="">====Select your slider category====</option>
                                    <option value="1">Desktop Slider</option>
                                    <option value="2">Mobile Slider</option>
                                </select>
                            </div>
                        </div>
                      <!-- /.form-group -->
