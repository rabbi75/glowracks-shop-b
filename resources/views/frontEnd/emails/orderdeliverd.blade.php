                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    ...
                                    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 22px; vertical-align: top; margin: 0; padding: 10px 10px;" valign="top">
                                            <p style="font-size:14px;margin:0">Thanks you!! your order delivered successfully.Thanks for purchase with Veewall. You can more purchas please with us at the following URL:{{url('/')}}</p><br>

                                            <p style="font-size:14px;margin:0">Thanks,</p>
                                            <p style="font-size:14px;margin:0">Ecom Four</p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
